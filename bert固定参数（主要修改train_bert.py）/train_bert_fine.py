...
from loader_bert import load_sentences, update_tag_scheme
from loader_bert import char_mapping, tag_mapping
from loader_bert import augment_with_pretrained, prepare_dataset
...
flags.DEFINE_string("result_path",  "result_two_fine_tune",       "Path for results")
flags.DEFINE_string("train_file",   os.path.join("data", "train_tag_two.txt"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("data", "dev_tag_two.txt"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("data", "test_tag_two.txt"),   "Path for test data")
