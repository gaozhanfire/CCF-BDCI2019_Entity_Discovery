...
class Model(object):
    def __init__(self, config):
        ...
        # bert模型参数初始化的地方
        init_checkpoint = "/home/ubuntu/zzp/bertNER/roberta_pre/chinese_L-12_H-768_A-12/bert_model.ckpt"
        # 获取模型中所有的训练参数。
    ...
    def bert_embedding(self):
        # load bert embedding
        bert_config = modeling.BertConfig.from_json_file("/home/ubuntu/zzp/bertNER/roberta_pre/chinese_L-12_H-768_A-12/bert_config.json")  # 配置文件地址。
